...
// // Komponen Section yang sudah "cerdas"
// const Section = ({
//   scrollYProgress,
//   start,
//   end,
...
//         y,
//         zIndex,
//         // Terapkan pointer-events secara dinamis berdasarkan prop isInteractive
...
//           height: '100%',
//         }}>
//         {/* Konten Anda (children) sekarang di dalam wrapper. */}
//         {/* Ukurannya akan dihormati dan tidak akan diregangkan. */}
//         {children}
//       </div>
//     </motion.div>
//   );
...
// // Komponen ParallaxScroller yang diperbarui
...
//     const heights = React.Children.map(children, (child) => {
//       return child.props.height || defaultSectionHeight;
//     });
...
//       totalHeight: totalScrollableHeight + 100,
//     };
...
//             // Kirim prop 'interactive' dari anak ke komponen Section
...
const Section = ({
  ...
  // const duration = end - start;
  // // Rentang input diubah agar lebih intuitif dan tidak tumpang tindih
  // const inputRange = [start, end];
  // // Elemen akan bergerak dari bawah (30%) ke atas (-30%) saat melewati viewport
  // const y = useTransform(scrollYProgress, inputRange, ['30%', '-80%']);
  const duration = end - start;
  const inputRange = [start, start + duration * 0.5, end, end + duration];
  const y = useTransform(scrollYProgress, inputRange, [
    '30%',
